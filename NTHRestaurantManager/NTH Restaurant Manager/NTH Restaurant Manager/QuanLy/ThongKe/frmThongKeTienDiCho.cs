...
{
    public partial class frmThongKeTienDiCho : Form
    {
        ThongKeRepository _repository = new ThongKeRepository();
        public frmThongKeTienDiCho()
        {
            InitializeComponent();
        ...
        private void btn_XacNhan_Click(object sender, EventArgs e)
        {
            ...
            thongKeTienDiCho(thongKe);
        }

        private async void thongKeTienDiCho(ThongKeModel thongKe)
        {
            List<ThongKeModel> list = await _repository.thongKeTienDiCho(thongKe);
            if (list == null)
            {
            ...
            {
                rpThongKeTienDiCho rp = new rpThongKeTienDiCho();
                ...
                foreach (ThongKeModel i in list)
                {
                    ...
                    var thang = i.ngay + "/" + i.thang + "/" + i.nam;
