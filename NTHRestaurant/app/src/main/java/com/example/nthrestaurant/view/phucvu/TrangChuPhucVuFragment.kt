...
class TrangChuPhucVuFragment : Fragment() {
    private var _binding: FragmentTrangChuPhucVuBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTrangChuPhucVuBinding.inflate(inflater, container, false)
        return binding.root
    }
